...
Events::Events(const char *filename)
    ...
    servmsg(this, "servmsg", "$00-- : %1"),
    servmsg2(this, "servmsg2", "$00-- : %1 %2"),
    servmsg3(this, "servmsg3", "$00-- %1:$16 %2"),
    ctcp(this, "ctcp", "$16-- CTCP$09 %1$16 received from $00%2"),
    ctcp_multi(this, "ctcp_multi", "$16-- CTCP$09 %1$16 received from $00%2$16 (to$09 %3$16)"),
    topicchange(this, "topicchange", "$16-- $00%1$16 changes topic to:$15 %2"),
    topicis(this, "topicis", "$16-- Topic for $11%1$16 is:$00 %2"),
    topictime(this, "topictime", "$16-- Set by $00%1$16 on $09%2"),
    noticepriv(this, "noticepriv", "$07NOTICE $00%1$07 : %2"),
    noticepubl(this, "noticepubl", "$07NOTICE $00%1$07 (to %2): %3"),
    error(this, "error", "$16-- Error:$08 %1"),
    away(this, "away", "$03User $0%1$03 is away $15($03%2$15)"),
    banlist(this, "banlist", "$16-- Ban: $09%1$16 set by: $00%2"),
    unknown(this, "unknown", "$16-- Unknown message: $02%1"),
    join(this, "join", "$16-- $00%1$11 $15($09%3$15)$16 has joined $11%2"),
    part(this, "part", "$16-- $00%1$16 $15($09%3$15)$16 has parted $11%2 (%4)"),
    part2(this, "part2", "$16-- $00%1$16 $15($09%3$15)$16 has parted $11%2"),
    quit(this, "quit", "$16-- $00%1$16 has quit $11(%2)"),
    nick(this, "nick", "$16-- $00%1$16 changes nick to %2"),
    mode(this, "mode", "$16-- $00%1$16 sets mode$09 %2$16 %3"),
    cmode(this, "cmode", "$16-- $00%1$16 sets channel mode$09 %2$16 on %3"),
    wallops(this, "wallops", "$08WALLOPS/<$00%1$8>$09 %2"),
    kicked(this, "kicked", "$16-- $00%1$16 was kicked from $11%2$16 by %3 $15($09%4$15)"),
    opped(this, "opped", "$16-- $00%1$16 gives channel operator status to %2"),
    deopped(this, "deopped", "$16-- $00%1$16 removes channel operator status from %2"),
    voiced(this, "voiced", "$16-- $00%1$16 gives voice to %2"),
    devoiced(this, "devoiced", "$16-- $0%1$16 removes voice from %2"),
    halfopped(this, "halfopped", "$16-- $00%1$16 gives channel half-operator status to %2"),
    halfdeopped(this, "halfdeopped", "$16-- $00%1$16 removes channel half-operator status from %2"),
    banned(this, "banned", "$16-- $00%1$16 sets ban on %2"),
    unbanned(this, "unbanned", "$16-- $00%1$16 unbans %2"),
    invited(this, "invited", "$16-- $00%1$16 invites you to join %2"),
    connecting(this, "connecting", "$16-- Connecting to$08 %1$16 on port$08 %2$16..."),
    names(this, "names", "$00-- Names$11 %1$00:$16 %2"),
    killed(this, "killed", "$16-- You were killed by $00%1$16 $15($09%2$15)")
{
