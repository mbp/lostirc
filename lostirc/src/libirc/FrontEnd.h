...
enum Event {
    ...
    ERROR, AWAY, BANLIST, UNKNOWN, JOIN, PART, PART2, QUIT, QUIT2, NICK,
    MODE, CMODE, WALLOPS, KICKED, OPPED, DEOPPED, VOICED, DEVOICED,
    HALFOPPED, HALFDEOPPED, BANNED, UNBANNED, INVITED, CONNECTING, NAMES,
    KILLED, WHOIS_USER, WHOIS_CHANNELS, WHOIS_SERVER, WHOIS_GENERIC
};
