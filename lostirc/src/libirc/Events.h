...
enum Event {
    ...
    SERVERMSG1, SERVERMSG2, CLIENTMSG, CTCP, CTCP_MULTI, TOPICCHANGE,
    TOPICIS, TOPICTIME, NOTICEPRIV, NOTICEPUBL, ERROR, AWAY, BANLIST,
    UNKNOWN, JOIN, PART, PART2, QUIT, QUIT2, NICK, MODE, CMODE, WALLOPS,
    KICKED, OPPED, DEOPPED, VOICED, DEVOICED, HALFOPPED, HALFDEOPPED,
    BANNED, UNBANNED, INVITED, CONNECTING, NAMES, KILLED, WHOIS_USER,
