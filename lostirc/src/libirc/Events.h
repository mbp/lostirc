...
enum Event {
    ...
    SERVMSG1, SERVMSG2, SERVMSG3, CLIENTMSG, CTCP, CTCP_MULTI, TOPICCHANGE,
    TOPICIS, TOPICTIME, NOTICEPRIV, NOTICEPUBL, ERROR, AWAY, BANLIST,
    UNKNOWN, JOIN, PART, PART2, QUIT, NICK, MODE, CMODE, WALLOPS, KICKED,
    OPPED, DEOPPED, VOICED, DEVOICED, HALFOPPED, HALFDEOPPED, BANNED,
    UNBANNED, INVITED, CONNECTING, NAMES, KILLED
};
