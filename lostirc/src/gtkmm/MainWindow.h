...
private:
    ...
    void onJoin(const string& nick, const string& channel, ServerConnection *conn);
    void onPart(const string& nick, const string& channel, ServerConnection *conn);
    void onQuit(const string& nick, const string& channel, ServerConnection *conn);
    ...
    void onNames(const string& channel, const vector<vector<string> >& users, ServerConnection *conn);
    void onTopic(const string& nick, const string& channel, const string& topic , ServerConnection *conn);
    void onTopicTime(const string& nick, const string& channel, const string& time , ServerConnection *conn);
    void onMode(const string& nick, const string& channel, const string& topic , ServerConnection *conn);
    void onUMode(const string& nick, const string& target, const string& topic , ServerConnection *conn);
    ...
    void onBanlist(const string& channel, const string& banmask, const string& owner, ServerConnection *conn);
